...
/*
 * Cart component is functional/stateless component
 * used to display shopping cart details in the Cart page
 */
const Cart = (props) => {
  //retrieve cart items array, addToCart method and removeFromCart method
  //passed as props
